...
function createStaticSelectElement({
  action_id,
  textByValue,
...
function createCheckboxListElement({
  action_id,
  options,
    ...
    options: options.map((option) => {
      return {
        ...
        description: option.description
          ? createPlainTextElement({ text: option.description })
          : undefined,
      };
    }),
...
class BlockMessageBuilder {
  ...
  addTextInput({
    ...
    return this.addInput({
      label,
      element: createTextInputElement({
        action_id,
        placeholder,
        initial_value,
        triggerOn,
  ...
  addCheckboxList({ label, action_id, options, initial_options = undefined }) {
    return this.addInput({
      label,
      element: createCheckboxListElement({
        action_id,
        options,
        initial_options,
      }),
