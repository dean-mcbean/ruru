...
const logEngineSuggestion = async (data) => {
  ...
  axios.post('https://api.usemotion.com/v1/tasks', {
    name: `Engine Suggestion: ${bugTitle}`,
    projectId: 'pr_85bcLG1GYKWsQ2Y9wAqxu6',
    ...
    console.log('Engine suggestion logged successfully:', response.data);
    ...
    sendMessage({
      ...
      markdown_text: `<@${user.id}> has logged this as a ![engine suggestion.](${taskUrl})`,
    }).then(response => {
